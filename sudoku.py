class sudoku:
 ...
 Q   5 6 7  8 9 1  2 3 4
            ...
            for b in range(0, 3):
                for c in range(0, 3):
                    for d in range(0, 3):
                        ...
                        if puzzle[count] != ".":
                            settingCell((a, b, c, d), int(puzzle[count]))
                        else:
                            settingCell((a, b, c, d), 0)
                        count += 1
    ...
    def checkGridValid(self):
        fullGrid = True
        checkingRow = self.checkRow
        checkingColumn = self.checkColumn
        checkingSquare = self.checkSquare
        for square in range(0, 3):
            for row in range(0, 3):
                resultRow = checkingRow((row, square))
                if resultRow == 0:
                    return 0
        ...
        for square in range(0, 3):
            for column in range(0, 3):
                resultColumn = checkingColumn((column, square))
                if resultColumn == 0:
        ...
        for row in range(0, 3):
            for column in range(0, 3):
                resultGrid = checkingSquare((row, column))
                if resultGrid == 0:
    ...
    def _checkSquare(self, loc):
        nums = []
        fullGrid = True
        gettingCell = self.getCell
        numsPush = nums.append

        for row in range(0, 3):
            for column in range(0, 3):
                x = gettingCell((loc[0], row, loc[1], column))
                if x != 0:
                    numsPush(x)
    ...
    def _solveGrid(self):
        ...
        for row in range(0, 3):
            for column in range(0, 3):
                for subRow in range(0, 3):
                    for subColumn in range(0, 3):
                        if self.grid[row][subRow][column][subColumn] == 0:
                            for i in range(1, 10):
                                self.grid[row][subRow][column][subColumn] = i
                                ...
                                # wrong input, delete
                                if result == 0:
                                    self.grid[row][subRow][column][subColumn] = 0
                                    continue
